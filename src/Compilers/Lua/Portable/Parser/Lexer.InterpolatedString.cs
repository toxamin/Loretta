...
//                 LorettaDebug.Assert(startingDollarSignCount > 0);
//
...
//                 LorettaDebug.Assert(totalAtCount + startingDollarSignCount + startingQuoteCount >= 2);
//
...
//                 if (CharUtils.IsNewLine(window.PeekChar()))
//                 {
...
//                 else
//                 {
//                     LorettaDebug.Assert(kind is InterpolatedStringKind.SingleLineRaw or InterpolatedStringKind.MultiLineRaw);
...
//             {
//                 LorettaDebug.Assert(kind is InterpolatedStringKind.Normal or InterpolatedStringKind.Verbatim);
//
...
//                     LorettaDebug.Assert(IsAtEnd(kind));
//
...
//                         LorettaDebug.Assert(closeQuoteCount >= startingQuoteCount);
...
//                     if (CharUtils.IsNewLine(_lexer.TextWindow.PeekChar()))
//                     {
//                         _lexer.TextWindow.AdvancePastNewLine();
//                         _lexer.ConsumeWhitespace(builder: null);
//                         var closeQuoteCount = _lexer.ConsumeQuoteSequence();
...
//                     }
//
//                     LorettaDebug.Assert(kind == InterpolatedStringKind.Verbatim);
...
//                 else
//                 {
//                     LorettaDebug.Assert(kind is InterpolatedStringKind.MultiLineRaw or InterpolatedStringKind.SingleLineRaw);
//
...
//                  */
//
//                 LorettaDebug.Assert(_lexer.TextWindow.PeekChar() == ':');
//                 _lexer.TextWindow.AdvanceChar();
//                 while (true)
//                 {
//                     char ch = _lexer.TextWindow.PeekChar();
...
//                             if (isHole)
//                             {
//                                 LorettaDebug.Assert(colonRange.Equals(default(Range)));
